...
public final class HttpUtils {
	...
	public static String doPost(String url, Map<String, String> params, Map<String, String> header, Duration timeout) {
		return _post(url, params, header, timeout);
	}

	public static String doPost(String url, Duration timeout) {
		return _post(url, null, BodyPublishers.noBody(), timeout);
	}
	...
	public static String doPost(String url, Map<String, String> header, String body, Duration timeout) {
		...
		return _post(url, header, bodyPublisher, timeout);
	}

	private static String _get(String url, Map<String, String> params, Map<String, String> header, Duration timeout) {
	...
	private static String _post(String url, Map<String, String> params, Map<String, String> header, Duration timeout) {
		...
		return _post(url, header, body, timeout);
	}

	private static String _post(String url, Map<String, String> header, BodyPublisher body, Duration timeout) {
		requireNonNull(url, "url must not be empty");
